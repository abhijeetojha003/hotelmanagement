...
insert into Hotel (id,name,managerID,ownerID,address,phone) values (1001,'Elizabeth Branch',2,1,'1 Elizabeth St., NSW 2000',040111114);
insert into Hotel (id,name,managerID,ownerID,address,phone) values (1002,'George Branch',3,1,'1 George St., NSW 2000',040111115);
...
insert into HotelRoom values (101,1001,13,'Single Room (with 1 single bed)','Available');
insert into HotelRoom values (1,1002,11,'Twin Bed (2 single beds)','Available');
